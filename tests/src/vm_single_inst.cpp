...
TEST(VM_SingleInst, NOP)
{
  ...
  chunk.add_closure();
  VM vm;
  chunk.get_closures()[0].add_code(OP_NOP, 0);
  chunk.get_closures()[0].add_code(OP_RETURN, 0);
...
TEST(VM_SingleInst, Int)
{
  ...
  VM vm;
  chunk.get_closures()[0].add_code(OP_CONSTANT, 0);
  chunk.get_closures()[0].add_code(uint16_t(0), 0);
  chunk.get_closures()[0].add_code(OP_RETURN, 0);
  ASSERT_EQ(vm.interpret(chunk), InterpretResult::OK);
...
TEST(VM_SingleInst, IntAdd)
{
  ...
  chunk.add_closure();
  chunk.add_constant(Value(int64_t(123)));
  chunk.add_constant(Value(int64_t(234)));
  VM vm;
  chunk.get_closures()[0].add_code(OP_CONSTANT, 0);
  chunk.get_closures()[0].add_code(uint16_t(0), 0);
  chunk.get_closures()[0].add_code(OP_CONSTANT, 0);
  chunk.get_closures()[0].add_code(uint16_t(1), 0);
  chunk.get_closures()[0].add_code(OP_ADD, 0);
  chunk.get_closures()[0].add_code(OP_RETURN, 0);
  ASSERT_EQ(vm.interpret(chunk), InterpretResult::OK);
  ASSERT_EQ(vm.get_stack_size(), 1);
  ASSERT_EQ(vm.top()->type, Value::I64);
...
TEST(VM_SingleInst, Str_Str_Add)
{
  ...
  VM vm;
  chunk.get_closures()[0].add_code(OP_STRING, 0);
  chunk.get_closures()[0].add_code(uint16_t(0), 0);
  chunk.get_closures()[0].add_code(OP_STRING, 0);
  chunk.get_closures()[0].add_code(uint16_t(1), 0);
  chunk.get_closures()[0].add_code(OP_ADD, 0);
...
TEST(VM_SingleInst, Double_Double_IntDiv)
{
  ...
  chunk.get_closures()[0].add_code(OP_CONSTANT, 0);
  chunk.get_closures()[0].add_code(uint16_t(1), 0);
  chunk.get_closures()[0].add_code(OP_INTDIV, 0);
  chunk.get_closures()[0].add_code(OP_RETURN, 0);
  ASSERT_EQ(vm.interpret(chunk), InterpretResult::OK);
  ASSERT_EQ(vm.get_stack_size(), 1);
  ASSERT_EQ(vm.top()->type, Value::I64);
...
TEST(VM_SingleInst, Double_Double_Div)
{
  ...
  chunk.get_closures()[0].add_code(OP_CONSTANT, 0);
  chunk.get_closures()[0].add_code(uint16_t(1), 0);
  chunk.get_closures()[0].add_code(OP_DIVIDE, 0);
  chunk.get_closures()[0].add_code(OP_RETURN, 0);
  ASSERT_EQ(vm.interpret(chunk), InterpretResult::OK);
  ASSERT_EQ(vm.get_stack_size(), 1);
  ASSERT_EQ(vm.top()->type, Value::F64);
